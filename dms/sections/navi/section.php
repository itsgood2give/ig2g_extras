...
class PLNavi extends PageLinesSection {
   ...
   function section_template( $location = false ) {
	...
	<div class="navi-wrap <?php echo $class; ?> fix">
      ...
      <!-- ipaterso added -->
        <!-- <div class="twitter-hover social-popout"></div>
        <div class="facebook-hover social-popout">
		<div class="instagram-hover social-popout">
		<div class="pinterest-hover social-popout">
        </div> -->
        <div class="twitter-popout social-popout"><img src="http://bradsknutson.com/wp-content/themes/bradsknutson/images/twitter-48circle.png" scale="0"></div>
        <div class="facebook-popout social-popout"><img src="http://bradsknutson.com/wp-content/themes/bradsknutson/images/facebook-48circle.png" scale="0"></div>
        <div class="instagram-popout social-popout"><img src="http://bradsknutson.com/wp-content/themes/bradsknutson/images/instagram-48circle.png" scale="0"></div>
        <div class="pinterest-popout social-popout"><img src="http://bradsknutson.com/wp-content/themes/bradsknutson/images/pinterest-48circle.png" scale="0"></div>
